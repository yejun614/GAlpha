// References by https://gist.github.com/niik/1017834
...
{
    /// <summary>
    /// Singleton Class for CryptoRandomImpl
    /// </summary>
    public class CryptoRandom {
        private static CryptoRandomImpl instance = new();

        internal static CryptoRandomImpl Instance { get => instance; set => instance = value; }
    }
    ...
    class CryptoRandomImpl : Random
    {
        ...
        /// </summary>
        public CryptoRandomImpl() : this(true) { }
        ...
        public CryptoRandomImpl(int ignoredSeed) : this(true) { }
        ...
        public CryptoRandomImpl(bool enableRandomPool)
        {
